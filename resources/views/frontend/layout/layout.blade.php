...
<head>
    ...
    {!! HTML::script('superfish/js/superfish.js') !!}
    {!! HTML::script('meanmenu/js/jquery.meanmenu.min.js') !!}


    {!! HTML::style('frontend/css/font-awesome.min.css') !!}
    {!! HTML::style('superfish/css/superfish.css') !!}
    {!! HTML::style('meanmenu/css/meanmenu.min.css') !!}
